import { IntervalName, Named, NoteName } from "@tonaljs/core";
/**
...
export declare const EmptyPcset: Pcset;
export declare type PcsetChroma = string;
export declare type PcsetNum = number;
/**
 ...
 */
export declare type Set = Partial<Pcset> | PcsetChroma | PcsetNum | NoteName[] | IntervalName[];
/**
 * Get the pitch class set of a collection of notes or set number or chroma
 */
export declare function get(src: Set): Pcset;
/**
 * Use Pcset.properties
 * @function
 * @deprecated
 */
export declare const pcset: (this: unknown, ...args: unknown[]) => Pcset;
/**
 * @private
 ...
 */
export declare function chromaToIntervals(chroma: PcsetChroma): IntervalName[];
/**
 ...
 */
export declare function chromas(): PcsetChroma[];
/**
 ...
 */
export declare function modes(set: Set, normalize?: boolean): PcsetChroma[];
/**
 ...
 */
export declare function isEqual(s1: Set, s2: Set): boolean;
/**
 ...
 */
export declare function isSubsetOf(set: Set): (notes: string | number | Pcset | Partial<Pcset> | string[] | string[]) => boolean | 0;
/**
 * Create a function that test if a collection of notes is a
 ...
 */
export declare function isSupersetOf(set: Set): (notes: Set) => boolean | 0;
/**
 ...
 */
export declare function isNoteIncludedIn(set: Set): (noteName: string) => boolean;
/** @deprecated use: isNoteIncludedIn */
export declare const includes: typeof isNoteIncludedIn;
/**
 ...
 */
export declare function filter(set: Set): (notes: string[]) => string[];
