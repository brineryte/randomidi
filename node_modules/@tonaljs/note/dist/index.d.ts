import { Note, note as props, NoteLiteral, NoteName, Pitch, transpose as _tr } from "@tonaljs/core";
/**
...
export declare const trBy: (interval: string) => (note: string) => string;
/**
...
export declare const trFrom: (note: string) => (interval: string) => string;
/**
...
declare const _default: {
    ...
    enharmonic: (noteName: string | Pitch) => string;
};
